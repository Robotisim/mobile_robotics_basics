...
void setup() {
  ...
  // Setup LEDC
  ledcSetup(channel_l1, freq, resolution123);
  ledcSetup(channel_l2, freq, resolution123);
  ledcSetup(channel_r1, freq, resolution123);
  ledcSetup(channel_r2, freq, resolution123);
